...
//        response_Dto.setSuccess(false);
        ...
        try {
            if (user_Dto == null) {
                ...
                jsonObject.addProperty("userfname", gson.toJson(user.getFname()));
                jsonObject.addProperty("userlname", gson.toJson(user.getLname()));
                jsonObject.addProperty("usermobile", gson.toJson(user.getMobile()));
                jsonObject.addProperty("useraddress", gson.toJson(user.getAddress()));
                jsonObject.addProperty("userEmail", gson.toJson(user.getEmail()));
